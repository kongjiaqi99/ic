package com.ic.icadmin.dto.response.loanItems;
 ...
 **/
@Data
@ApiModel(value = "LoanItemDetailResponse", description = "Loan Item Detail Response")
public class LoanItemDetailResponse {
    ...
    public LoanItemDetailResponse(LoanItemsEntity entity) {
