...
public class ApiClientServiceImpl implements IApiClientService {
    ...
    public static String REGISTER_CLIENT_EMAIL_SUBJECT = "Register Client For ic";
    public static String VISITOR_CLIENT_EMAIL_SUBJECT = "Visitor For ic";
    public static String RESET_PIN_EMAIL_SUBJECT = "Reset Pin For ic";
    ...
    public CommonResponse<Long> shareApp(ShareAppRequest request, HttpServletRequest httpRequest) throws Exception {
        ...
        try {
            ...
            msgUtil.send("61"+request.getPhone(),"ic", "Apple Store link: [Insert Apple Store link]\n" +
    ...
    public void pushEventMsg(List<Long> clientId) {
        ...
        for (ClientsEntity clientsEntity : clientsEntities) {
            try {
                param.put("title", ObjectUtil.equals(LanguageEnum.CN.getCode(), clientsEntity.getLanguage()) ? "海利有新的活动" : "New ic event is coming");
                param.put("pushClientId", clientsEntity.getPushClientId());
                param.put("content", MapUtil.getStr(param, "title"));
                HttpUtil.post(pushUrl, JSONUtil.toJsonStr(param));
            } catch (Exception e) {
    ...
    public CommonResponse<String> resetPasswordCodeMsgSend(ResetPasswordCodeSendRequest request) {
        ...
        // generate Email
        try {
            msgUtil.send("61"+request.getMobile(),"ic", "reset password code:" + securityCode);
        } catch (Exception e) {
    ...
    public CommonResponse<String> resetPinMsgSend() {
        ...
        // generate Email
        try {
            msgUtil.send("61"+s,"ic", "reset pin code:" + securityCode);
        } catch (Exception e) {
